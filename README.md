...
For some time, I have maintained a simple spreadsheet of AI/machine learning use cases by business function and industry.  With the arrival of ChatGPT, I built an automated process that uses ChatGPT to augment my table with summary information on (1) how Large Language Models (LLMs), such as ChatGPT, might be applied to each use case and (2) other algorithms that could be helpful.  
